...
app.get('/login', function(req, res) {
	...
	res.render('frontmatter/login.jade', {loginMessage: loginError})
});
...
app.get('/register', function(req, res){
	...
	res.render('userCreation/register.jade', {registerMessage: registerError});
});

//show page to set up a new user profile
app.get('/setupNewUser', function(req, res){

	res.render('userCreation/chooseClass.jade', {});
...
app.get('/searchResults', function(req, res){
	...
	res.render('internalPages/searchResults.jade', {	searchResults: searchBuffer[req.user['_id']], 
										page: req.query.page, 
...
app.get('/userProfile', function(req, res){
	...
	res.render('internalPages/userProfile.jade', {user: req.user, disciplines: disciplines, languages: languages});
	...
	connect(function(err, db) {
		db.collection('Users', function(er, collection) {	    	
	    	collection.find( {scientist: req.user.developer, language : {$in: req.user.language}, discipline : {$in: req.user.discipline}} ).toArray(function(err, matches){
	    		...
	    		res.render('internalPages/userMatches.jade', {match: matches, 
	    										page: req.query.page, 
...
app.get('/userSearch', function(req, res){
	...
	res.render('internalPages/userSearch.jade', {languages: languages, disciplines: disciplines});
	...
	connect(function(err, db) {
		db.collection('Users', function(er, collection) {
	    	collection.findOne( {uName: req.query.userID}, function(err, user){
	    		res.render('internalPages/readonlyProfile.jade', {user: user});
	    	});
		});
	});
});
	...
	connect(function(err, db) {
		db.collection('Users', function(er, collection) {
	    	collection.findOne( {uName: req.query.username}, function(err, user){
	    		res.render('utilityPages/contactUser.jade', {user: user});
	    	});
		});
	});
});
...
app.get('/changePasswordForm', function(req, res){
	...
	return res.render('utilityPages/changePassword.jade');
...
app.get('/forgotPass', function(req, res){
	...
	res.render('utilityPages/recoverPassword.jade');
